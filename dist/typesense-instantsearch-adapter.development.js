(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('typesense')) :
  typeof define === 'function' && define.amd ? define(['typesense'], factory) :
  (global = global || self, global.TypesenseInstantsearchAdapter = factory(global.typesense));
}(this, (function (typesense) { 'use strict';
  ...
  var TypesenseInstantsearchAdapter = /*#__PURE__*/function () {
    function TypesenseInstantsearchAdapter(options) {
      ...
      this.typesenseClient = new typesense.SearchClient(this.configuration.server);
      this.searchClient = {
          ...
          return regeneratorRuntime.wrap(function _callee5$(_context5) {
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  requestAdapter = new SearchRequestAdapter(instantsearchRequest, this.typesenseClient, this.configuration.additionalSearchParameters);
                  _context5.next = 3;
