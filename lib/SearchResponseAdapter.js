  ...
  (0, _createClass2["default"])(SearchResponseAdapter, [{
    ...
    value: function _adaptGroupedHits(typesenseGroupedHits) {
      ...
      adaptedResult = typesenseGroupedHits.map(function (groupedHit) {
        return _this._adaptHits(groupedHit);
      }).flat();
        ...
        if (Array.isArray(value)) {
          ...
          value.forEach(function (v) {
            result[attribute].push({
              value: _this3._adaptHighlightTag(_he["default"].decode("".concat(v))),
          ...
          result[attribute].value = _this3._adaptHighlightTag(_he["default"].decode("".concat(value)));
        }
      });
      return result;
    }
